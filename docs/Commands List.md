...
----------|----------------|--------------|-------
 ...
 MuteCommands | `.mute` | Mutes a mentioned user both from speaking and chatting. You can also specify time in minutes (up to 1440) for how long the user should be muted. **Requires ManageRoles server permission.** **Requires MuteMembers server permission.** | `.mute @Someone` or `.mute 30 @Someone`
 ...
 SelfCommands | `.scrm` | Removes a startup command with the provided command text. **Bot owner only** | `.scrm .stats`
 ...
 UserPunishCommands | `.warnpunish` `.warnp` | Sets a punishment for a certain number of warnings. Provide no punishment to remove. **Requires BanMembers server permission.** | `.warnpunish 5 Ban` or `.warnpunish 3`
 UserPunishCommands | `.warnpunishlist` `.warnpl` | Lists punishments for warnings.  | `.warnpunishlist`
 UserPunishCommands | `.ban` `.b` | Bans a user by ID or name with an optional message. **Requires BanMembers server permission.** | `.b "@some Guy" Your behaviour is toxic.`
...
----------|----------------|--------------|-------
 ...
 Connect4Commands | `.connect4` `.con4` | Creates or joins an existing connect4 game. 2 players are required for the game. Objective of the game is to get 4 of your pieces next to each other in a vertical, horizontal or diagonal line.  | `.connect4`
...
----------|----------------|--------------|-------
 ...
 NSFW | `.e621` | Shows a random hentai image from e621.net with a given tag. Tag is optional but preferred. Use spaces for multiple tags.  | `.e621 yuri kissing`
...
----------|----------------|--------------|-------
 ...
 Permissions | `.permrole` `.pr` | Sets a role which can change permissions. Supply no parameters to see the current one. Default is 'Ene'.  | `.pr role`
...
----------|----------------|--------------|-------
 ...
 Searches | `.say` | Bot will send the message you typed in this channel. Supports embeds.  | `.say hi`
 ...
 Searches | `.yodify` `.yoda` | Translates your normal sentences into Yoda styled sentences!  | `.yoda my feelings hurt`
 ...
 Searches | `.color` `.clr` | Shows you which colors correspond to the inputed hexes.  | `.color 00ff00` or `.color f00 0f0 00f`
...
----------|----------------|--------------|-------
 ...
 PatreonCommands | `.parewrel` | Forces the update of the list of patrons who are eligible for the reward.  | `.parewrel`
...
Submodule | Commands and aliases | Description | Usage
----------|----------------|--------------|-------
 Xp | `.experience` `.xp` | Shows your xp stats. Specify the user to show that user's stats instead.  | `.xp`
